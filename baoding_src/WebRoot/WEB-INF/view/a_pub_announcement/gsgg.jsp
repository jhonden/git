...
<div class="main">
    ...
    <div class="ab-main clearfix">
        ...
        <div class="left fl">
            ...
            <ul class="left-nav">
                <li><a title="公示公告" class="current" href="gsgg.html" style="z-index:2;">公示公告</a></li>
            </ul>
        ...
        <!--right-->
        <div class="right fr">
            <div class="right-top">您当前的位置： 首页 &gt; 公示公告 &gt; 公示公告 </div>
            <div class="right-cen">
                <div class="com_text">
                    <ul class="cont1_ul_news">
                        <li><strong>[2016-08-29]</strong><a target="_blank" href="gsgg_01.html">关于公证机构入围比选公告</a></li>



                        <li><strong>[2016-08-29]</strong><a target="_blank" href="gsgg_02.html">关于保险机构（诉讼保全保险业务）入围比选公告</a></li>


                    </ul>

                    <span id="ctl00_ContentPlaceHolder1_Pager1_pagelab"><div class="SplitPage" align="center"><span class="pagecount"> 总共2条记录  </span><span class="allpage"> 第1/1页  </span><a href="index.html">首页</a> <a href="">上一页</a> <span class="nowpage"> 1 </span> <a href="">下一页</a>  <a href="">尾页</a> </div>
</span>
