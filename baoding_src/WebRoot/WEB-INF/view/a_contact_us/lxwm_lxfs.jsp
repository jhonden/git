...
<div class="main">
    ...
    <div class="ab-main clearfix">
        ...
        <div class="left fl">
            ...
            <ul class="left-nav">
                <li><a title="联系方式" class="current" href="lxwm_lxfs.html" style="z-index:2;">联系方式</a></li> <li><a title="举报信箱" href="lxwm_jbxx.html" style="z-index:2;">举报信箱</a></li>
            </ul>
        ...
        <!--right-->
        <div class="right fr">
            <div class="right-top">您当前的位置： 首页 &gt; 联系我们 &gt; 联系方式 </div>
            <div class="right-cen">
                <p><span style="font-size: 12px;"></span></p><table><tbody><tr class="firstRow"><td width="1230" valign="top" style="word-break: break-all;"><p style="white-space: normal;"><span style="font-size: 12px;">名称：</span>四川发展融资担保股份有限公司&nbsp;</p><p style="white-space: normal;">地址：成都市高新区交子大道177号中海国际中心A座16层</p><p style="white-space: normal;">网址：www.scfzdb.cn&nbsp;&nbsp;www.scfzdb.com.cn</p><p style="white-space: normal;">电话：86-028-80587196</p><p style="white-space: normal;">传真：86-028-80587200</p></td><td width="414" valign="top" style="word-break: break-all;"><img src="image/6356755301642187505223487.png" title="" alt="" width="353" height="273" border="0" vspace="0" style="width: 353px; height: 273px;"></td></tr></tbody></table><p><span style="font-size: 12px;"></span></p>
            </div>
        </div>
        <!--right End-->
    </div>
